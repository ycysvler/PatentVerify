...
export default class Monitor extends React.Component {
    constructor(props) {
        ...
        this.state ={"indexList": [], "leftIndex": [],topMenuKey:"06","leftMenuKey":this.getMenuKey()};
    ...
    getMenuKey=()=>{
        ...
        if(url.indexOf("monitor/agent")>-1){return "0601";}
    }
            ...
            <Layout >
                ...
                <Layout className="patent-layout-content">
                    <Router>
                        <Switch>
                            {/*外观.快速检索.历史查询*/}
                            <Route path="/main/monitor/agent" component={AgentList}/>
